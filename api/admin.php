...
if ($action === 'deliveries') {
    $stmt = $pdo->query("SELECT o.id, o.user_id, o.created_at as date, u.name as user_name, o.total FROM orders o JOIN users u ON o.user_id = u.id ORDER BY o.created_at DESC");
